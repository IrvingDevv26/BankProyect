                ...
                <div class="col-12">
                    <div class="card-neo" id="documento-pdf">
                        <div class="d-flex justify-content-between align-items-center border-bottom pb-4 mb-4">
                            <div>
                                <h2 class="fw-bold text-primary m-0"><span
                                        style="color:var(--accent-color)">Neo</span>Bank</h2>
                                <small class="text-muted">Estado de Cuenta Oficial</small>
                            </div>
                            <div class="text-end">
                                <h5 class="fw-bold mb-0">Periodo: <?= $meses[$mes_actual] ?> <?= $anio ?? date('Y') ?>
                                </h5>
                        ...
                        <div class="row mb-4 p-3 bg-light rounded-3 mx-0">
                            <div class="col-6">
                                <small class="text-uppercase text-muted fw-bold"
                                    style="font-size: 0.7rem;">Titular</small>
                                <div class="fw-bold text-dark"><?= $_SESSION['nombre'] ?></div>
                            </div>
                            <div class="col-6 text-end">
                                <small class="text-uppercase text-muted fw-bold" style="font-size: 0.7rem;">Cuenta /
                                    CLABE</small>
                            ...
                            <tbody>
                                <?php if (count($movimientos) > 0): ?>
                                    <?php foreach ($movimientos as $m):
                                        ...
                                        ?>
                                        <tr>
                                            <td><?= date('d/m/Y', strtotime($m['fecha_transaccion'])) ?></td>
                                            <td>
                                                <div class="fw-bold text-dark"><?= ucfirst($m['tipo_transaccion']) ?></div>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="3" class="text-center py-4 text-muted">No hay movimientos en este
                                            periodo.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
