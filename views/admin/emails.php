    ...
    <div id="content">
        <nav class="navbar navbar-expand-lg navbar-light bg-transparent mb-4">
            <div class="container-fluid">
                ...
                <h4 class="ms-3 fw-bold text-primary mb-0">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle">
                    ...
                    <tr>
                        ...
                        <th style="width: 20%" class="text-end">Fecha</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php foreach ($emails as $email): ?>
                        <tr>
                            ...
                            <td>
                                <div class="fw-bold text-dark"><?= htmlspecialchars($email['destinatario']) ?></div>
                                <small class="text-muted">SMTP Local</small>
                            </td>
                            <td>
                                <div class="fw-bold text-primary mb-1"><?= htmlspecialchars($email['asunto']) ?></div>
