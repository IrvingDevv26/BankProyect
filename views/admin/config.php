        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent mb-4">
                <div class="container-fluid">
                    ...
                    <h4 class="ms-3 fw-bold text-primary-var mb-0">Configuración de Administrador</h4>
                </div>
            </nav>

            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="card-neo bg-surface-1 border-theme border">
                        <h5 class="fw-bold text-primary-var mb-4">Cambiar Contraseña Maestra</h5>
                        ...
                        <form id="form-password-admin">
                            <div class="mb-3">
                                ...
                                <input type="password" name="current_password"
                                    class="form-control bg-surface-2 border-theme border text-primary-var" required>
                            </div>
                            <div class="mb-3">
